...
The 24 September coastal update uses the owner's new photographs to refine neighbouring cabins: horizontal dark weatherboarding, framed windows, the southern cabin's upper storey and terracotta roof, a low waterfront shelter, pale quay skirting, lifebuoys and blue flotation barrels. These are photo-informed approximations on the mapped footprints; the original red cabin and island assets are preserved.

Four motorboats are moored around the island and neighbouring quays. Blue triangles mark boats on the minimap. Press **E / controller Y** to board or leave: the boat must be stopped beside reachable shore or a quay, with a clear boarding path. The first aboard drives; up to four hunters share separate positions. Use **W/S and A/D**, or the **left stick**, for throttle and steering; **Space / controller A** brakes. Forward maximum speed is **9.1125 m/s**, 50% above normal sprint. Releasing the controls slows to a stop. The next passenger takes over when the driver leaves. Boats return to their moorings when a new round starts, so they cannot be stranded at sea. Boats and passengers use host-authoritative movement in online co-op and local split screen.

Unalerted wolf packs now travel between shared destinations, spread out while moving, and occasionally pursue visible nearby land animals together. During a confrontation, stable flank positions distribute wolves around the hunter before staggered attacks. Werewolves calmly search broader areas near hunters, using terrain routes and their existing perception and warning rules before charging.
...
Small red Amanita muscaria clusters with cream spots occasionally grow on navigable terrain. Approach and press **E / controller Y** to consume one. Each player can consume a cluster once per round; another player's pickup does not take yours away. **Psychedelic** lasts until the next cabin rest: highly vivid colours, the normal map with tiny skulls marking dangerous animals and human enemies throughout the map, and **30% lower maximum HP**, with current HP capped immediately. Additional mushrooms do not compound the penalty. It stacks with lycanthropy: 70 HP before the permanent upgrade, 140 HP afterwards. Rest clears psychedelic and restores the usual maximum. The mushroom effect is a fictional game mechanic.

The **Primitive Fire Siphon** is a fictional brass, hand-pumped flame weapon costing **850 credits**. Hold left mouse / right trigger for flame pulses: 48 base damage to each exposed target within a 56-degree cone every 0.2 seconds, 5 m effective reach, 10 m maximum, 25 fuel pulses (five seconds) loaded plus 75 reserve, and a 5-second reload. Fuel replenishes at round rest. Flames stop at walls, can burn other hunters, and cannot be fired indoors or while sprinting. The weapon has an original model, orange flame particles and a synthesised fire roar. It is available in stores, Free Play and the main-menu stat guide.
...
Each mission has a 22% chance to attempt a devil encounter at an outdoor navigable point. The red devil wears a checked tweed suit, has 1,000 HP and begins neutral. Approach and press E/Y to **Sell your soul for power**: permanently halve your maximum-health factor for three random ritual stacks. The cost is visible in the prompt before interacting. Each hunter can accept once per devil. Killing him instead pays 535 shared credits (500 bonus plus 35 human bounty). He only fights back after a player damages him; nearby gunfire, approaching and non-player damage do not provoke him. Soul costs and boons last until the run ends.
